...
*** hardware-configuration.nix
This file is copied from =/etc/nixos/hardware-configuration.nix= and dropped into =~/.../Technonomicon/Artemis/NixOS/hardware-configuration.nix= as part of any fresh install. At some point I would like to be able to standardize it.
...
***** Xmonad
:PROPERTIES:
:header-args: :tangle ./Artemis/Home-Manager/Home-Packages/xmonad.nix
:END:
