...
**** alacritty.nix
:PROPERTIES:
:header-args: :tangle ./Thanatos/Home-Manager/Home-Packages/alacritty.nix
:END:
...
**** zsh.nix
:PROPERTIES:
:header-args: :tangle ./Thanatos/Home-Manager/Home-Packages/zsh.nix
:END:
...
***** eww.nix
:PROPERTIES:
:header-args: :tangle ./Thanatos/Home-Manager/Home-Packages/Emacs/eww.nix
:END:
