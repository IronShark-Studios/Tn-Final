...
***** placeholder
:PROPERTIES:
:header-args: :tangle ./Thanatos/NixOS/Tools/Scripts/placeholder.txt
:END:
...
**** picom.nix
:PROPERTIES:
:header-args: :tangle ./Thanatos/Home-Manager/Home-Packages/picom.nix
:END:
...
**** unclutter.nix
:PROPERTIES:
:header-args: :tangle ./Thanatos/Home-Manager/Home-Packages/unclutter.nix
:END:
