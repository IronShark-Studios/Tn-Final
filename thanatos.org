...
#+LAST_MODIFIED: [2023-11-22 Wed 17:33]
...
(setq heading-color "Azure3")
(dolist (face '((org-level-1 . heading-color)
                (org-level-2 . heading-color)
                (org-level-3 . heading-color)
                (org-level-4 . heading-color)
                (org-level-5 . heading-color)
                (org-level-6 . heading-color)
                (org-level-7 . heading-color)
                (org-level-8 . heading-color)))
